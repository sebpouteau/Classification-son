...
# python knn.py ../Data/Res/train_features.csv ../Data/Res/train_labels.csv ../Data/Res/eval_features.csv  0 193 3000 1000 8 ../Data/csv/tt.csv
if __name__ == '__main__':
    ...
    tr_features, tr_labels, ts_features, ts_labels = func.extract(1, train_features, train_label, nbTrain, start_features, end_features)

    training_epochs = nbEpoch
    n_dim =  tr_features.shape[1]
    n_classes = nbClasse
    n_hidden_units_one = 800
    ...
    with tf.Session() as sess:
            ...
            for epoch in range(training_epochs):
                ...
                if(epoch % 1000 == 0):
                   ...
                   # np.savetxt("Data/resultat/1.csv", history, delimiter=",")

                history.append([round(sess.run(accuracy, feed_dict={X: ts_features, Y: ts_labels}), 5), avg_cost])
